    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          {/* RIGHT: Phone Pills + Member Portal + ORDER NOW Button */}
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Member Account / Athlete Sign In Button */}
            <button
              onClick={onOpenLogin}
              id="navbar-member-auth-btn"
              ...
              title={currentUser ? `Signed in as ${currentUser.name}` : 'Sign in to CoreFuel'}
            >
              {currentUser ? (
                <>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            {/* Member Sign In button in mobile menu */}
            <div className="mb-4">
              <button
                onClick={() => {
                  setMobileMenuOpen(false);
              ...
              >
                <User className="w-4 h-4 text-[#00d2ff]" />
                <span>{currentUser ? `Account: ${currentUser.name}` : 'Sign in to CoreFuel'}</span>
              </button>
            </div>
