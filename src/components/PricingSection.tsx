  ...
  return (
    <section className="py-24 lg:py-32 bg-[#090b10] relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Single Prominent Pricing Card (ORANGE - 25 SERVINGS) */}
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-label-pkg text-amber-400 font-semibold tracking-wider">25 SERVINGS</span>
              </div>
              ...
              <ul className="space-y-3 mb-8 text-sm text-zinc-300 font-body">
                <li className="flex items-center gap-2.5">
                  ...
                  <span>25 full servings of micronized creatine monohydrate</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-[#ff7700]" />
