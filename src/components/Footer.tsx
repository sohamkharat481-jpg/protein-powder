        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="font-body text-zinc-400 text-xs leading-relaxed max-w-sm">
              CoreFuel Nutrition supplies pure, micronized creatine monohydrate built for disciplined, everyday training. 25 servings in refreshing Orange with 900 mg L-Taurine.
            </p>
          </div>
